...
class DatatpsSearchKelurahan extends DatatpsEvent {
  String? kelurahan;

  DatatpsSearchKelurahan({this.kelurahan});
}

class DatatpsSearch extends DatatpsEvent {
  String? value;

  DatatpsSearch({this.value});
}
